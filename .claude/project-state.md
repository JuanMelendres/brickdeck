...
1. Set inventory slice 4: import endpoint (`POST /api/v1/catalog/sets/{setNumber}/inventory/import`) + read endpoint `GET /api/v1/sets/{setNumber}/parts` → `PageResponse<SetPartResponse>`.
